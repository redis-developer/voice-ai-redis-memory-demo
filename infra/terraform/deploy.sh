...
MEMORY_SERVER_EMBEDDING_MODEL="${MEMORY_SERVER_EMBEDDING_MODEL:-text-embedding-3-large}"
MEMORY_SERVER_VECTOR_DIMENSIONS="${MEMORY_SERVER_VECTOR_DIMENSIONS:-3072}"
...
export TF_VAR_memory_server_embedding_model="$MEMORY_SERVER_EMBEDDING_MODEL"
export TF_VAR_memory_server_vector_dimensions="$MEMORY_SERVER_VECTOR_DIMENSIONS"
export TF_VAR_openai_chat_model="$OPENAI_CHAT_MODEL"
